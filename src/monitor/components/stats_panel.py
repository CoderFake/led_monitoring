"""
Stats Panel - Component to display detailed statistics
"""
...
class StatsPanel(ft.Container):
    ...
    def __init__(self, engine):
        ...
        self.led_count_text = ft.Text("0", size=18, weight=ft.FontWeight.BOLD, color=ThemeColors.PRIMARY, text_align=ft.TextAlign.CENTER)
